      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 pt-8">
            ...
            <button className="text-gray-400 hover:text-red-500 transition-colors p-1 cursor-pointer hover:bg-gray-200 rounded-[50%]">
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-10 text-center">
            ...
            <button className="w-full py-4 bg-[#1e2331] text-white rounded-full font-bold text-sm tracking-wide hover:bg-black transition-all cursor-pointer">
              متابعة التسوق
            </button>
          </div>
          ...
          <div className="p-6 border-t border-gray-100 bg-gray-50/50">
            ...
            <div className="flex gap-3">
              <Link
                href="/cart"
                className="flex-1 py-4 bg-[#435ebe] text-white rounded-full font-bold text-center text-sm hover:opacity-90 transition-opacity"
              >
                مشاهدة السلة
              </Link>
