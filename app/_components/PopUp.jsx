...
export default function PopUp() {
  ...
  return (
    ...
    >
      {/* - max-h-[90dvh]: لضمان عدم خروج النافذة عن الشاشة طولياً
          - w-full: لتأخذ كامل العرض المتاح في الشاشات الصغيرة جداً
          - max-w-125: الحد الأقصى للشاشات الكبيرة
      */}
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative w-full max-w-[500px] max-h-[90dvh] overflow-y-auto rounded-2xl bg-white shadow-2xl transition-all flex flex-col
